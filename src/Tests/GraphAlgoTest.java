...
class GraphAlgoTest {
    ...
    void shortestPathDist() {
        ...
        a.load("G1.json");
        double s = a.shortestPathDist(1,4);
    ...
    void shortestPath() {
        ...
        a.load("G1.json");
        DirectedWeightedGraph g1 = a.getGraph();
        List<NodeData> l1 = a.shortestPath(1, 4);
        ...
        DirectedWeightedGraph g3 = a.getGraph();
        g3.removeEdge(13,14);
        l1 = a.shortestPath(3, 30);
        assertNotEquals(a.shortestPathDist(3,30), 5.10225682606953);
        a.load("G2.json");
        DirectedWeightedGraph g2 = a.getGraph();
        g2.removeEdge(2,6);
        l1 = a.shortestPath(2, 6);
        l2.clear();
        l2.add(g2.getNode(2));
        l2.add(g2.getNode(3));
        l2.add(g2.getNode(4));
